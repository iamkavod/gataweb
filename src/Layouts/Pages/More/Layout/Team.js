            ...
            <section className="px-4 py-24 mx-auto max-w-[1443px] md:px-24 lg:px-8 lg:py-40">
                <div className='flex flex-col gap-10'>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Ubongabasi Joseph is a skilled frontend developer dedicated to creating seamless user experiences within the GATA Protocol ecosystem.</p>
                        <div className='flex items-center gap-5 lg:text-3xl text-[20px] text-yellowShade'>
                            <FaLinkedin />
                            <FaSquareXTwitter />
                        </div>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className='text-white'>Frontend Developer</p>
                        <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Audrey Tan is a frontend developer with a passion for creating intuitive and visually appealing interfaces for GATA Protocol users.</p>
                        <div className='flex items-center gap-5 lg:text-3xl text-[20px] text-yellowShade'>
                            <FaLinkedin />
                            <FaSquareXTwitter />
                        </div>
