  ...
  return (
    <main className='bg-darkShadeA'>
      ...
      <main className="flex flex-col items-center justify-center px-4 pt-16 mx-auto max-w-[1443px] lg:pt-32 md:px-0">
        ...
        <section>
          <h1 className='text-yellowShade lg:text-3xl text-xl text-center pt-20 pb-5'>Community Platforms</h1>
        ...
        <section className='lg:pt-20 pt-10'>
          ...
          <div className='flex flex-col gap-3 mt-3'>
            <p className='text-darkShadeB lg:text-xl text-sm'>Testimonial</p>
            <ul className='list-disc ml-6'>
              <li className='text-darkShadeB'>Shape the Future of GATA Protocol</li>
              <li className='text-darkShadeB'>Exclusive Access to Special Features</li>
              <li className='text-darkShadeB'>Earn Compensations for Contributions</li>
              <li className='text-darkShadeB'>Participate in Community Governance</li>
            </ul>
          </div>
        </section>
          ...
          <div>
            <div className="flex flex-col">
              <div className=" lg:mb-10">
                <div className='flex flex-col gap-3 mt-3'>
                  <p className='text-darkShadeB lg:text-xl text-sm'>  How to Join & Get Started:</p>
                  <ul className='list-disc ml-6'>
                    <li className='text-darkShadeB'><span className='text-white'>Infographic:</span> A visual guide to joining the community, from purchasing a membership NFT to accessing Discord and Telegram.</li>
                    <li className='text-darkShadeB'><span className='text-white'>Video:</span> An embedded explainer video that walks users through the Discord channels, governance process, and how to get involved.</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className='flex flex-col gap-3 mt-3 w-full'>
          <h1 className='text-yellowShade lg:text-3xl text-xl text-center pt-20 pb-5'>Ready to Become a GATA Member?</h1>
          ...
          <ul className='list-disc ml-6'>
            ...
            <li className='text-darkShadeB'>Complete the <span className='text-white'>“1billion2web3 Initiatives”</span>web3 onboardiing course and receive your verifiable NFT certificate.</li>
            <li className='text-darkShadeB'>Click the Link to connect with the <span className='text-white'>GATA community</span> on Discord and Telegram.</li>
            <li className='text-darkShadeB'>Engage actively to enjoy all the community benefits.</li>
          </ul>
          <p className='text-yellowShade lg:text-xl text-sm'>Members with a GATA Pass NFT gain exclusive rights, including governance participation and early access to new features.</p>

          <div className='w-full flex justify-center pb-10'>
            <div className='lg:mt-5 mt-3 rounded-lg spin-btn p-2 border'>
              <a
                href='/'
                className="inline-flex items-center justify-center w-full lg:h-16 h-10 lg:px-20 px-10 lg:text-xl text-xs font-bold tracking-wide text-black transition duration-200 rounded shadow-md md:w-auto bg-yellowShade focus:shadow-outline focus:outline-none capitalize text-center"
              >
                Secure Your Membership and <br /> Join the GATA Community!
              </a>
            </div>
          </div>
        </div>
