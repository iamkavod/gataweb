      ...
      <section>
        <section>
          <div className="relative">
            <div className="relative">
              <div className="px-4 py-20 mx-auto max-w-[1443px] md:px-24 lg:px-8 lg:py-32">
                ...
                <div className='flex flex-col gap-3 pt-10'>
                  ...
                  <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-darkShadeB lg:text-[20px] text-[12px]'>A Time-bound Non-Fungible Tokens (NFTs) representing annual co-operative membership access and governance rights within the ecosystem.</p>
                  </div>
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-white font-bold lg:text-lg text-sm'>Membership Plans</h1>
                    <p className='text-darkShadeB lg:text-[20px] text-[12px] '>We have different tiers of membership NFTs plan available with varying benefits and durations, such as:</p>
                ...
                <div className='flex flex-col gap-3 py-5'>
                  <h1 className='text-yellowShade font-bold lg:text-3xl text-xl'>Benefits of GATA Membership</h1>
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-white font-bold lg:text-lg text-sm'>Access To Exclusive Features</h1>
                    <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Enjoy special features and early access to new developments within the ecosystem.</p>
                  </div>
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-white font-bold lg:text-lg text-sm'>Community Influence</h1>
                    <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Influence ecosystem decisions through participation in governance and discussions.</p>
                  </div>
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-white font-bold lg:text-lg text-sm'>Discounts and Rewards</h1>
                    <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Receive discounts on platform fees and exclusive rewards.</p>
                  </div>
                </div>

                <div className='flex flex-col gap-3 py-5'>
                  <h1 className='text-yellowShade font-bold lg:text-3xl text-xl'>To Get GATA Membership NFT</h1>
                  <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Acquiring a GATA Membership NFT is a prestigious step into our community.</p>
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-white font-bold lg:text-lg text-sm'>Purchase</h1>
                    <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Keep an eye out for GATA Membership NFT sales on our platform or partner marketplaces.</p>
                  </div>
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-white font-bold lg:text-lg text-sm'>Engage</h1>
                    <p className='text-darkShadeB lg:text-[20px] text-[12px]'>Actively engage in our community, demonstrate commitment, and you might be selected for a GATA Membership NFT drop.</p>
                  </div>
                </div>
                ...
                <div className='flex flex-col gap-3 pt-4'>
                  ...
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-yellowShade font-bold lg:text-3xl text-xl'>Token Details</h1>
                    <div className='flex flex-col gap-5'>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>Token Name</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>GATA Token</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>Symbol:</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>GATA</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                      ...
                      <div className='gap-2'>
                        ...
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>ERC-20</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>Decimal:</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>18</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>Blockchain:</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>Optimism</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>Initial token price:</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>$0.0005 per GATA</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>initial market capitalization:</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>$50,000(based on the circulating supplyat lunch)</li>
                        </ul>
                      </div>
                    </div>
                  </div>

                  <h1 className='text-yellowShade font-bold lg:text-3xl text-xl mt-5'>Token Use Cases</h1>
                  <div className='flex flex-col gap-3'>
                    <div className='flex flex-col gap-5'>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>For Ecosystem Currency</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>GATA Tokens are used to pay for products and services fees within the GATA Protocol ecosystem.</li>
                        </ul>
                      </div>
                      <div className='gap-2'>
                        <p className='text-white font-bol lg:text-md text-xs'>For Incentives & Rewards</p>
                        <ul className='list-disc flex flex-col gap-5 ml-6'>
                          <li className='text-darkShadeB lg:text-[20px] text-[12px]'>Users earn GATA Tokens as rewards or compensation within the ecosystem.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='mt-5'>
                    <h1 className='text-yellowShade font-bold lg:text-3xl text-xl'>Token Distribution</h1>
                        ...
                        <div className='flex flex-col gap-3'>
                          ...
                          <div className='gap-2 ml-3'>
                            ...
                            <ul className='list-disc flex flex-col gap-5 ml-6'>
                              ...
                              <li className='text-white lg:text-[20px] text-[12px]'>Year 2: <span className='text-darkShadeB'>10% unlocked</span></li>
                              <li className='text-white lg:text-[20px] text-[12px]'>Years 3-6: <span className='text-darkShadeB'>21.25% unlocked annually</span></li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div className='w-full flex justify-center'>
                    <div className='lg:mt-3 mt-5 rounded-lg spin-btn p-2 border'>
                      <a
                        href='/buyandsell'
                        className="inline-flex items-center justify-center w-full lg:h-12 h-8 lg:px-20 px-10 lg:text-xl text-sm font-bold tracking-wide text-black transition duration-200 rounded shadow-md md:w-auto bg-yellowShade focus:shadow-outline focus:outline-none capitalize"
                      >
