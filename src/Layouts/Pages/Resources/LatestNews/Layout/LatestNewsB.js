        ...
        <div className="flex flex-col gap-10 max-w-[1443px] sm:mx-auto lg:max-w-full">
          ...
          <div className="overflow-hidden transition-shadow duration-300 bg-darkShadeA rounded">
            ...
            <div className="py-5 flex flex-col gap-2">
              ...
              >
                <p className="text-2xl font-bold leading-5 text-yellowShade underline">Partnership with Lotus Global Alliance</p>
              </a>
              ...
              <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                <li className='text-white lg:text-md text-sm'>Web3 Marketing Strategies: <span className='text-darkShadeB font-bold'>Expert guidance on leveraging Web3 technologies to drive growth and innovation.</span></li>
                <li className='text-white lg:text-md text-sm'>Blockchain and Tokenization: <span className='text-darkShadeB font-bold'>Tailored solutions to harness the power of blockchain and tokenization for your business</span></li>
                <li className='text-white lg:text-md text-sm'>NFTs and Metaverse: <span className='text-darkShadeB font-bold'>Insightful strategies to explore and capitalise on the potential of NFTs and the Metaverse.</span></li>
              </ul>
              <p className="mb-4 text-darkShadeB">
              ...
              <a
                ...
                className="inline-block mb-3 text-black transition-colors duration-200"
              >
                <p className="text-2xl font-bold leading-5 text-white underline">Discover More About Our Partnership</p>
              </a>
            </div>
          </div>
        </div>
