                ...
                <div className="flex flex-col gap-10 max-w-[1443px] sm:mx-auto lg:max-w-full">
                    ...
                    <div className="overflow-hidden transition-shadow duration-300 bg-darkShadeA rounded">
                        ...
                        <div className="py-5 flex flex-col gap-2">
                            ...
                            >
                                <p className="text-2xl font-bold leading-5 text-yellowShade underline">GATA Token lunch on Uniswap</p>
                            </a>
                            ...
                            <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                                <li className='text-white lg:text-md text-sm'>Increased Liquidity: <span className='text-darkShadeB font-bold'> The GATA Token will be more accessible than ever, enabling easier trading and participation in the DeFi space.</span></li>
                                <li className='text-white lg:text-md text-sm'>Decentralized Trading: <span className='text-darkShadeB font-bold'>Enjoy the benefits of decentralized trading on Uniswap, including enhanced security and control over your assets. </span></li>
                                <li className='text-white lg:text-md text-sm'>Optimism Blockchain: <span className='text-darkShadeB font-bold'>Leveraging the scalability and speed of the Optimism Blockchain, transactions will be faster and more cost-effective.</span></li>
                            </ul>
                            <p className="mb-4 text-darkShadeB">
                            ...
                            <a
                                ...
                                className="inline-block mb-3 text-black transition-colors duration-200"
                            >
                                <p className="text-2xl font-bold leading-5 text-white underline">Learn More About the GATA Token Launch</p>
                            </a>
                        </div>
                    </div>
                </div>
