        ...
        <div className="flex flex-col gap-10 max-w-[1443px] sm:mx-auto lg:max-w-full">
          ...
          <div className="overflow-hidden transition-shadow duration-300 bg-darkShadeA rounded">
            ...
            <div className="py-5 flex flex-col gap-2">
              ...
              >
                <p className="text-2xl font-bold leading-5 text-yellowShade underline">Upcoming Events</p>
              </a>
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-darkShadeB lg:text-md text-sm'>-Every 2nd and 4th Wednesday of every month at 4:00 PM</li>
                  <li className='text-white lg:text-md text-sm'>Where: <span className='text-darkShadeB font-bold'>Discord Voices (Link)</span></li>
                  <li className='text-white lg:text-md text-sm'>What: <span className='text-darkShadeB font-bold'>Join us for our regular community meet-ups where we discuss onboarding processes, provide community updates, and foster connections within the GATA Protocol ecosystem. Don’t miss this chance to connect and share with fellow community members.</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-white lg:text-md text-sm'>When: <span className='text-darkShadeB font-bold'>Every last Friday of every month at 8:00 PM</span></li>
                  <li className='text-white lg:text-md text-sm'>Where: <span className='text-darkShadeB font-bold'>Discord Voices (Link)</span></li>
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-white lg:text-md text-sm'>When: <span className='text-darkShadeB font-bold'>Every 2nd Thursday of every month at 2:30 PM</span></li>
                  <li className='text-white lg:text-md text-sm'>Where: <span className='text-darkShadeB font-bold'>Discord Voices (Link)</span></li>
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-white lg:text-md text-sm'>When: <span className='text-darkShadeB font-bold'>Every 2nd Tuesday of every third month at 5:00 PM</span></li>
                  <li className='text-white lg:text-md text-sm'>Where: <span className='text-darkShadeB font-bold'>Google Meet (Link)</span></li>
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-white lg:text-md text-sm'>When: <span className='text-darkShadeB font-bold'>Every 1st Friday of every November at 3:00 PM</span></li>
                  <li className='text-white lg:text-md text-sm'>Where: <span className='text-darkShadeB font-bold'>Google Meet (Link)</span></li>
              ...
              <a
                ...
                className="inline-block mb-3 text-black transition-colors duration-200"
              >
                <p className="text-2xl font-bold leading-5 text-white underline">Explore All Upcoming Events</p>
              </a>
            </div>
          </div>
        </div>
