            ...
            <div className="py-5 flex flex-col gap-2">
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-white lg:text-md text-sm'>Engage with Posts: <span className='text-darkShadeB font-bold'>Like, comment, share, and interact with GATA Protocol's social media posts.</span></li>
                  <li className='text-white lg:text-md text-sm'>Earn GATA Tokens: <span className='text-darkShadeB font-bold'>Each interaction will earn you GATA Tokens, rewarding your active participation.</span></li>
                  <li className='text-white lg:text-md text-sm'>Be a Part of Our Community: <span className='text-darkShadeB font-bold'>Join a vibrant community of users who are passionate about decentralized technologies and the GATA Protocol.</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className='list-disc pl-6 py-2 flex flex-col gap-2'>
                  <li className='text-white lg:text-md text-sm'>Get Rewarded: <span className='text-darkShadeB font-bold'>Turn your social media engagement into tangible rewards.</span></li>
                  <li className='text-white lg:text-md text-sm'>Stay Informed: <span className='text-darkShadeB font-bold'>Keep up-to-date with the latest news, updates, and developments within the GATA Protocol ecosystem.</span></li>
                  <li className='text-white lg:text-md text-sm'>Support GATA Protocol: <span className='text-darkShadeB font-bold'>Help spread the word and contribute to the growth of our community. </span></li>
                </ul>
              </div>
              <p className="mb-4 text-darkShadeB">
              ...
              <a
                ...
                className="inline-block mb-3 text-black transition-colors duration-200"
              >
                <p className="text-2xl font-bold leading-5 text-white underline">Find Out More About Engage2Earn</p>
              </a>
            </div>
          </div>
        </div>
